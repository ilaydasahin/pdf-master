...
import { Upload, FileText, Loader2, Wrench } from 'lucide-react';
...
export default function RepairPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('PDF onarılamadı. Lütfen tekrar deneyin.');
      console.error(err);
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="mx-auto max-w-3xl px-6 py-12 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="text-lg leading-8 text-slate-600">
          Bozuk veya hasarlı PDF dosyalarını onarın
        </p>
      </div>
          ...
          <div className="flex justify-center rounded-lg border border-dashed border-slate-900/25 px-6 py-10 hover:bg-slate-50 transition-colors">
            <div className="text-center">
              {file ? (
                ...
                <>
                  <Wrench className="mx-auto h-12 w-12 text-slate-300" aria-hidden="true" />
